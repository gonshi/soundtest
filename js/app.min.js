...
/*!
  ...
  *
 */
window._DEBUG?null!=Object.freeze?window.DEBUG=Object.freeze(window._DEBUG):window.DEBUG={state:!0}:null!=Object.freeze?window.DEBUG=Object.freeze({state:!1}):window.DEBUG={state:!1},a("../js/velocity.min.js"),window.DUR=500,$(function(){var a,b,c,d,e,f,g;return e=$(".wrapper-sound"),b=$(".icon_container"),a=b.find(".icon"),c=$(".modal_container-sound"),d=c.find(".ok"),f=[],g=5,d.on("click",function(){var a,b,d;for(a=b=0,d=g;d>=0?d>b:b>d;a=d>=0?++b:--b)f[a]=new Audio,f[a].src="audio/"+(a+1)+".mp3",f[a].play(),f[a].pause();return setTimeout(function(){return f[0].play()},5e3),c.velocity({opacity:[0,1]},DUR,function(){return c.hide()})}),a.on("touchstart",function(a){var b;return b=Math.floor(Math.random()*g),f[b].currentTime=0,f[b].play(),$(a.currentTarget).velocity({scale:[1.1,1]},DUR/4).velocity({scale:[1,1.1]},DUR/4)})})},{"../js/velocity.min.js":2}],2:[function(a,b,c){/*! VelocityJS.org (1.2.2). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
